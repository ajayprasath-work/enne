...
export default function filterReports() {
    ...
    return (
        <>
            <Header />
            <div className="flex flex-col mt-[40px] lg:mt-[80px]  h-full md:px-5 lg:px-[20px] pt-[20px] pb-0 lg:mb-[30px] relative">
                ...
                <div className="flex bg-[#fff] p-4 lg:p-[20px] flex-col rounded-[10px] gap-[10px] shadow-2xl mb-[20px]">
                    ...
                    <div>
                        <span className="text-[20px] text-[#D5B0C2] font-bold">Completed</span>
                        <div className="overflow-x-scroll lg:overflow-x-hidden overflow-y-auto mt-2.5">
                            <table className="whitespace-nowrap">
                                <thead>
                                    <tr>
                    ...
                    <div>
                        <span className="text-[20px] text-[#D5B0C2] font-bold">Downloaded</span>
                        <div className="overflow-x-scroll lg:overflow-x-hidden overflow-y-auto mt-2.5">
                            <table className="whitespace-nowrap">
                                <thead>
                                    <tr>
