...
export default function CreditHistory({ openVal }: addCompanyProps) {
    return (
        <section className="w-full h-screen flex justify-end items-center backdrop-blur-sm  bg-black/30 fixed top-0 right-0 z-50">
            <div className="bg-white p-4 flex flex-col w-[34.625rem] max-w-[34.625rem] overflow-y-auto h-screen gap-8">
                <div className="flex w-full justify-between items-center">
                    ...
                    <span className="cursor-pointer " onClick={openVal}><Close width={26} height={26}  className="cursor-pointer"/></span>
                </div>
