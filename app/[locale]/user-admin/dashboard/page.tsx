...
import { Calender, CardCompanies, CardCredits, UserCardIcon } from "@/public/assets/icon/Icon";
...
export default function ForgetPassword() {
  ...
  return (
    <>
    <Header />
    <div className="flex w flex-col !h-full p-5  lg:p-[20px]  mt-[40px] lg:mt-[70px]">
