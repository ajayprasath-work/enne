             ...
             <div className='w-full flex flex-col gap-3 lg:gap-5 md:w-[calc(53%_-_2.5rem)]'>
               ...
               {tindex("about.Unlock")}
                   ...
                   <div className='mt-2 lg:mt-5'>
                    <a href="http://localhost:3004/en/register" target='_blank' title='Register Now' className='inline-block py-2.5 px-8 border rounded-4xl border-light-150 text-base font-medium text-white tracking-wide'>{tindex("about.Register Now")}</a>
                   </div>
             </div>
          </div>
        </div>
