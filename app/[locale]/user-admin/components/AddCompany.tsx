...
export default function AddCompany({openVal}:addCompanyProps) {
    return (
        <section className="w-full h-screen flex justify-end items-center bg-black/20 fixed top-0 right-0 z-50">
            <div className="bg-white p-4 flex flex-col w-[34.625rem] max-w-[34.625rem] h-screen gap-8">
                <div className="flex w-full justify-between items-center">
                    <span className="text- font-bold text-xl">Add Company</span>
                    <span className="cursor-pointer " onClick={openVal}><Close/></span>
                </div>
                ...
                <div className="flex w-full items-center gap-4 mt-auto">
                    ...
                    <Form_btn border={'transprant'} text={'white'} bg={'red-150'} label="Submit" />
                </div>
            </div>
        </section>
    );
